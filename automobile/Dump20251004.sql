...
LOCK TABLES `add_features` WRITE;
/*!40000 ALTER TABLE `add_features` DISABLE KEYS */;
/*!40000 ALTER TABLE `add_features` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2025-10-04 12:47:44
